  ...
  return (
    <form className="contact-form" onSubmit={handleSubmit} noValidate data-reveal>
      ...
      <div className="form-grid">
        ...
        <label><span>I’m interested in</span><select name="interest" value={values.interest} onChange={(event) => updateField("interest", event.target.value)} aria-invalid={Boolean(errors.interest)} aria-describedby={errors.interest ? "interest-error" : undefined}><option value="pilot-free">Free pilot for one grade, up to 100 students</option><option value="pilot-starter">₹8,000 Pilot Starter</option><option value="starter">₹30,000 Starter</option><option value="growth">₹80,000 Growth</option><option value="enterprise">Enterprise</option><option value="general-demo">A guided walk through the product</option></select>{fieldError("interest")}</label>
