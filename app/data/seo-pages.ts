...
export const seoPages = {
  about: {
    name: "About Unifloe",
    intro:
      "Unifloe is made by PaperKite, a small team in Bengaluru. We built it after sitting with schools and watching attendance, marks and fees move between paper, spreadsheets and phone calls.",
    highlights: [
      { title: "A small team you can call", copy: "The person who answers the contact page builds the product and sets up every school." },
      { title: "Built from school conversations", copy: "Every module started as something a principal, teacher or office told us was slowing them down." },
      { title: "Free for one class", copy: "Any teacher or school can start with one class at no cost, forever, and grow from there." },
    ],
    sections: [
      {
        title: "Why we built Unifloe",
        lead: "In conversations with Bengaluru schools the same things came up: attendance on paper typed up later, report cards rebuilt in spreadsheets every term, fees in three registers, and consent paperwork nobody owned.",
        points: [
          "Mark attendance once, on a phone, and let parents see it",
          "Enter marks once and print report cards and hall tickets from them",
          "One fee ledger, with receipts issued the moment a payment is recorded",
          "Parent consent recorded properly under the DPDP Act",
        ],
      },
      {
        title: "Who you deal with",
        lead: "PaperKite is a small team, not a call centre. When you write or call, you reach the people who build Unifloe and who will set your school up.",
        points: [
          "Phone: +91 9686110206, WhatsApp welcome",
          "Email: adithya@unifloe.app",
          "Based in Bengaluru, and happy to visit a school in the city",
          "Support continues inside the product after you go live",
        ],
      },
      {
        title: "How we work with a school",
        lead: "You look first, we call back, and we do the setup with you.",
        points: [
          "Try the live demo with its guided tour, no account needed",
          "Send four fields and we call back within a working day",
          "We create the school and hand over the Head Admin login",
          "A review point after the first term, so the rollout stays calm",
        ],
      },
      {
        title: "What we will not do",
        lead: "Schools hold children's data, so a few things are fixed.",
        points: [
          "No advertising, no analytics that track children, no selling of data",
          "No card or bank details stored, and no Aadhaar numbers",
          "No consent given on a parent's behalf",
          "No feature described on this site that does not exist; what is coming is labelled coming soon",
        ],
      },
    ],
    related: [
      { href: "/data-privacy", label: "How school data is handled", copy: "Who is responsible for what under the DPDP Act, and the safeguards in the product." },
      { href: "/features", label: "Explore the platform", copy: "The six areas of Unifloe, in plain words." },
